...
<!--    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl md:min-w-">-->
      <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <img class="mx-auto h-40 w-auto top-model" src="../src/assets/img/pixelcut-export1.png?color=green&shade=600" alt="Your Company" />
            ...
            <div class="h-16 mb-10">
              ...
              <div class="mt-2">
                <input type="email" v-model="email" name="email" id="email" autocomplete="email"
                       class="peer/email drop-shadow-none shadow-none block w-full rounded-md bg-white px-3 py-2.5
              ...
              <div class="mt-2">
                <input type="password" v-model="password" name="password" id="password"
                       autocomplete="current-password" class="peer/password drop-shadow-none block
                        w-full rounded-md bg-white px-3 py-2.5 text-base text-gray-900
...
<!--              <div class="peer-[.is-dirty]:peer-required:block hidden">This field is required.</div>-->
            ...
            <div class="h-16">
              <button type="submit" @submit="submit()" @click="submit()"
                      class="flex w-full justify-center rounded-md bg-green-600 px-3 py-2.5 text-sm/6 font-semibold
...
<!--          </p>-->
  ...
  <div style="bottom: 3px;">
    <p class="mt-2 text-white">© 2025 <a href="#" class="inline-block mt-1 text-lg anchor-green-500 hover:anchor-green-700 leading-tight font-medium te xt-black hover:underline">BFC SARL</a> All rights reserved.</p>
  </div>
...
.top-model:hover {
  filter: drop-shadow(0 0 2em #15803DFF);
}
.btn {
...
<script type="text/javascript">
  ...
  export default {
    components: {
      RecoverPassword, // register component
    },
  };
</script>